...
UPLOAD_FOLDER = r'G:\New Project\Face-Recognition-Attendance-System-main\IMAGE_FILES'
...
def gen():
    IMAGE_FILES = []
    filename = []
    dir_path = r'G:\New Project\Face-Recognition-Attendance-System-main\IMAGE_FILES'
